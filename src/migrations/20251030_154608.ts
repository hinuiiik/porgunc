...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('polls', 'posts');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('polls', 'posts');
  ...
  CREATE TABLE "pages_blocks_archive" (
  	...
  	"relation_to" "enum_pages_blocks_archive_relation_to" DEFAULT 'polls',
  ...
  CREATE TABLE "_pages_v_blocks_archive" (
  	...
  	"relation_to" "enum__pages_v_blocks_archive_relation_to" DEFAULT 'polls',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_polls_fk" FOREIGN KEY ("polls_id") REFERENCES "public"."polls"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_polls_fk" FOREIGN KEY ("polls_id") REFERENCES "public"."polls"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "redirects_rels_polls_id_idx" ON "redirects_rels" USING btree ("polls_id");
  ...
  CREATE INDEX "search_rels_polls_id_idx" ON "search_rels" USING btree ("polls_id");
